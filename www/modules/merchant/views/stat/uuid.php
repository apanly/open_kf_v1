...
<div class="row">
    <div class="row-in">
        <div class="columns-24">
			<?php echo \Yii::$app->view->renderFile("@www/modules/merchant/views/stat/tab.php", ['current' => 'uuid']); ?>
        </div>
    </div>
</div>
<div class="row">
				...
				<?php if($data):?>
					<?php foreach($data as $_item):?>
                        <tr>
                            ...
                            <td><?=$_item['date'];?> </td>
                            <td>
                                <a  class="color-theme"  target="_blank" href="<?=GlobalUrlService::buildMerchantUrl("/stat/trace",[ 'uuid' => $_item['uuid'] ]);?>">
									<?=$_item['uuid'];?>
                                </a>
                            </td>
